...
<body style="background-image:url(images/bookback2.jpg)">
...
<div class="super_container">
	...
	<div class="wrapper py-5" >
		<div class="row">
			<div class="col-md-12">
				<!-- <h1 class="text-center">Books my Details</h1> -->
			</div>
		</div>
		<div class="row mt-4">
			...
			while($row = mysqli_fetch_assoc($query_run)){
				...
				<div class="cards">
					<div class="cards-body">
						...
						<img src="<?php echo $row['image']; ?>" class="card-img" alt="book image">
						<div class="intro">
						...
						<div class="button button_color_1 text-center trans_200"><a href="register.php">Request</a></div>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-3 footer_col">
						...
						<div class="footer_column_content">
							<ul>
								...
								<li class="footer_list_item"><a href="Services.php">Service</a></li>
								<li class="footer_list_item"><a href="book.php">Book</a></li>
							</ul>
						</div>
					</div>
